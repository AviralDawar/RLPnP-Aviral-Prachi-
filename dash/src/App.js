...
import TemporalData from "./components/TemporalData";
import TemporalDropdown from "./components/TemporalDropdown";
...
function App() {
 ...
 const [showTemporal,setTemporal] = useState(false);
 ...
 function TemporalFeature(childData) {
   data.temporalAttribute = childData.temporalAttribute;
   console.log("Temporal Attribute ", childData, data.temporalAttribute);
 } 
 ...
 function Temporal_data(childData){
   if(childData.isTemporal==='True'){
     setTemporal(true);
   ...
   <div className="App">
     ...
     {showResults ? null : (
       <div>
         ...
         {/* make a text box here to ask if the data is temporal or not and if it is then ask which attributes are temporal pass the options also */}
         <div className = "div">
         
           <TemporalData childToParent={Temporal_data}/>
          
          
         </div>
         {showTemporal ? <div className = "div">
           <TemporalDropdown options={options} childToParent={TemporalFeature} /></div>:null}
